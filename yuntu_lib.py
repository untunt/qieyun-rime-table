...
韻圖屬性列表 = [
    # 　　　　　２ＢＡ４Ｃ１
    韻圖屬性類('　幽幽　尤侯', '　', 0, '流　攝', ' Ɨw'),  # 幽韻歸屬有爭議，畫韻圖時算作重紐韻。另外侯韻是開口
    韻圖屬性類('　　　　魚　', '開', 0, '遇　攝', ' Ə'),
    韻圖屬性類('　　　　虞模', '　', 0, '遇　攝', 'wƏ'),
    韻圖屬性類('　　　　之　', '開', 0, '止　攝', ' Ɨ'),
    韻圖屬性類('　脂脂　微　', '開', 0, '止　攝', ' Ɨj'),
    韻圖屬性類('　脂脂　微　', '合', 0, '止　攝', 'wƗj'),
    韻圖屬性類('佳支支　　　', '開', 0, '止蟹攝', ' E'),
    韻圖屬性類('佳支支　　　', '合', 0, '止蟹攝', 'wE'),
    ...
    韻圖屬性類('耕　　青　　', '開', 1, '梗　攝', ' Əŋ'),
    韻圖屬性類('耕　　青　　', '合', 1, '梗　攝', 'wƏŋ'),
    韻圖屬性類('庚庚清　　　', '開', 1, '梗　攝', ' Aŋ'),
    韻圖屬性類('庚庚清　　　', '合', 1, '梗　攝', 'wAŋ'),
    韻圖屬性類('　　　　陽唐', '開', 1, '宕　攝', ' Aɴ'),
    韻圖屬性類('　　　　陽唐', '合', 1, '宕　攝', 'wAɴ'),
